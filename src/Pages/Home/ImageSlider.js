...
import { Navigation, Pagination, Grid, Autoplay } from 'swiper/modules';// import required modules
  ...
  return (
    <>
      <div className='navigators'>
        <button className='swiper-button-prev btn' title='Prev'><ArrowBackIosNewIcon /></button>
        <button className='swiper-button-next btn' title='Next'><ArrowForwardIosIcon /></button>
      </div>
      <Swiper
        slidesPerView={1}
        spaceBetween={30}
